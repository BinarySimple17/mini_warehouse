...
public class CatalogController {
    ...
    @GetMapping
    public PagedModel<CatalogFullDto> getAll(@ParameterObject @ModelAttribute CatalogFilter filter, @ParameterObject Pageable pageable) {
        Page<CatalogFullDto> catalogFullDtos = catalogService.getAll(filter, pageable);
        return new PagedModel<>(catalogFullDtos);
    }
