...
{{ include "warehouse-service.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "warehouse-service.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "warehouse-service.fullname" .) .Values.serviceAccount.name }}
{{- else }}
